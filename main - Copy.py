...
def generate_advisory(persona_id: str, message: str) -> str:
    prompt = f"""
    You are {PERSONAS[persona_id]}, a legendary business leader. Provide detailed, point-wise strategic guidance to the query below:

    Query: {message}

    Structure response with headings and numbered/bullet points.
    """
    try:
